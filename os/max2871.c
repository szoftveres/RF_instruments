...
// 0 = Frac-N, 1 = Int-N
void max2871Set_INT (max2871_t* instance, uint32_t j) {
...
void max2871Set_CPOC (max2871_t* instance, uint32_t j) {
	instance->registers[1] &= ~(0x1 << 31);
	instance->registers[1] |= j << 31;
}

// Charge Pump Linearity
void max2871Set_CPL (max2871_t* instance, uint32_t j) {
	instance->registers[1] &= ~(0x3 << 29);
	instance->registers[1] |= j << 29;
}

// Charge Pump Test
void max2871Set_CPT (max2871_t* instance, uint32_t j) {
	instance->registers[1] &= ~(0x3 << 27);
	instance->registers[1] |= j << 27;
}

// Phase Value
void max2871Set_P (max2871_t* instance, uint32_t j) {
...
// Lock Detect Speed
void max2871Set_LDS (max2871_t* instance, uint32_t j) {
	instance->registers[2] &= ~(0x1 << 31);
	instance->registers[2] |= j << 31;
}

// Low Noise / Spur Mode
void max2871Set_SDN (max2871_t* instance, uint32_t j) {
	instance->registers[2] &= ~(0x3 << 29);
	instance->registers[2] |= j << 29;
}

// Mux Config
void max2871Set_MUX (max2871_t* instance, uint32_t j) {
...
// Cycle Slip Mode
void max2871Set_CSM (max2871_t* instance, uint32_t j) {
	instance->registers[3] &= ~(0x1 << 18);
	instance->registers[3] |= j << 18;
}

// Mute Delay Mode
void max2871Set_MUTEDEL (max2871_t* instance, uint32_t j) {
	instance->registers[3] &= ~(0x1 << 17);
	instance->registers[3] |= j << 17;
}

// Clock Divider Mode
void max2871Set_CDM (max2871_t* instance, uint32_t j) {
	instance->registers[3] &= ~(0x3 << 15);
	instance->registers[3] |= j << 15;
}

// Clock Divider Value
void max2871Set_CDIV (max2871_t* instance, uint32_t j) {
	instance->registers[3] &= ~(0xFFF << 3);
	instance->registers[3] |= j << 3;
}

// Shutdown VCO LDO
void max2871Set_SDLDO (max2871_t* instance, uint32_t j) {
	instance->registers[4] &= ~(0x1 << 28);
	instance->registers[4] |= j << 28;
}

// Shutdown VCO Divider
void max2871Set_SDDIV (max2871_t* instance, uint32_t j) {
	instance->registers[4] &= ~(0x1 << 27);
	instance->registers[4] |= j << 27;
}

// Shutdown Ref Input
void max2871Set_SDREF (max2871_t* instance, uint32_t j) {
	instance->registers[4] &= ~(0x1 << 26);
	instance->registers[4] |= j << 26;
}

// Band-Select MSBs
void max2871Set_BS (max2871_t* instance, uint32_t j) {
...
// VCO Feedback Mode
void max2871Set_FB (max2871_t* instance, uint32_t j) {
...
void max2871WriteRegisters (max2871_t* instance) {
